...
def _fused_rot_quant_moe_sort_impl(
    ...
    elif use_gluon_kw8 and topk in (1, 8) and RS == 128:
        from vllm.model_executor.layers.quantization.quark.fused_rotation_quant_sort_triton import (
            fused_rot_quant_sort_triton,
        )
        return fused_rot_quant_sort_triton(
            x, rotation, RS,
